  ...
  return (
    <section className="text-center mb-24">
      ...
      <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-10">
        Build a magazine-style travel content platform named Wanderlust
        featuring long-form travel stories, a destination search, and rich
        photo-led article layouts.
      </p>
